...
frame_tela = Frame(janela, width=235, height=50, bg=co4)
...
app_label = Label(frame_tela, textvariable=valor_texto, width=16, height=2, padx=7, relief=FLAT, anchor="e", justify=RIGHT, font=('Ivy 18'), bg=co4, fg=co2)
...
b_3 = Button(frame_corpo, command=lambda: entrar_valores('/'), text="/", width=5, height=2, bg=co11, fg=co2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_3.place(x=177, y=0)
...
b_7 = Button(frame_corpo, command=lambda: entrar_valores('*'), text="*", width=5, height=2, bg=co11, fg=co2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_11 = Button(frame_corpo, command=lambda: entrar_valores('-'), text="-", width=5, height=2, bg=co11, fg=co2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_15 = Button(frame_corpo, command=lambda: entrar_valores('+'), text="+", width=5, height=2, bg=co11, fg=co2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_15.place(x=177, y=156)

b_1 = Button(frame_corpo, command=lambda: entrar_valores('0'), text="0", width=11, height=2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_1.place(x=0, y=208)

b_2 = Button(frame_corpo, command=lambda: entrar_valores('.'), text=".", width=5, height=2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_2.place(x=118, y=208)

b_3 = Button(frame_corpo, command=calcular, text="=", width=5, height=2, bg=co11, fg=co2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
